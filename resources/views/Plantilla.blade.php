<!--esta es una plantilla que se extiende de layout/admin para añadir opciones al menu se debe ir a 
esta plantilla, se instalo sweetalert  para mostrar mensajes de confirmacion en los controladores 
se debe redireccionar ->with('icon', 'success')->with('title', 'Método de pago eliminado')->with('message', 'El método de pago se ha eliminado exitosamente.')
con un icono, titulo y mensaje esto ya esta instalado en la palntilla padre solo la de eliminacion se debe poner en cada 
modulo nuevo-->
    ...
    <div class="col-12 col-md-12 col-lg-12">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <!-- Botón para abrir el modal de creación de método de pago nombre del modal "data-bs-target"-->
                <div class="modal-primary me-1 mb-1 d-inline-block">
                    ...
                    <!-- Modal de creación de método de pago, el "id" debe coincidir con el "data-bs-target" del botón -->
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                @foreach($customers as $customer)
                                    <tr>
                                        ...
                                        <!--Botones de acción para cada cliente, con modales para mostrar y editar información, y un formulario para eliminar el cliente. El "data-bs-target" de cada botón debe coincidir con el "id" del modal correspondiente.-->
                        ...
                        @foreach($customers as $customer)
                            ...
                            <!-- Modal para mostrar información para evitar modificaciones se añadio "readonly"-->
                        ...
                        @endforeach
                        <!--Paginación de la tabla, utilizando el sistema de paginación de Laravel y adaptándolo a Bootstrap 5-->
...
<!--Funcione para abrir el modal si existiera un error tanto en el modal de creacion o edicion
esto se logra mediate un imput oculto llamado "edit_id" que se llena con el id del cliente que se esta editando, si el valor de "edit_id" es diferente de null se abre el modal de edición, caso contrario se abre el modal de creación. 
-->
@if ($errors->any())
    <script>
...
<!--Script para confirmar la eliminación de un cliente por swet alert -->
<script>
