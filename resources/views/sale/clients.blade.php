...
@section('title')
    ...
    <p class="text-subtitle text-muted">Aquí puedes revisar todas las ventas registradas para clientes y acceder al detalle de cada transacción.</p>
@endsection
@section('navegacion')
    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Inicio</a></li>
            <li class="breadcrumb-item active" aria-current="page">Ventas de Clientes</li>
        </ol>
    </nav>
@endsection
@section('content')
                            ...
                            <table class="table table-hover table-bordered table-striped align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">C.I. Cliente</th>
                                ...
                                <tbody>
                                    @foreach($sales as $sale)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $sale->customer?->ci ?? 'N/A' }}</td>
                                            
                                            <!-- Nombre limitado a 20 caracteres como en tu modelo -->
                                            <td>{{ Str::limit($sale->customer?->full_name ?? 'Sin Miembro', 20, '...') }}</td>
